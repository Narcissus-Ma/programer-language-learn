...
## HTML/CSS 示例
<HtmlPreview src="/programer-language-learn/demo/circleLoading.html" height="auto" />

以下是HTML/CSS中圆进度条 -->的示例代码：
  ...
  <body>
    ...
    <script>
      ...
      function loadingRing() {
        ...
        cxt.lineWidth = 20;
        cxt.arc(midx, midy, 100, 0, (Math.PI * angle) / 180);
        cxt.stroke();
        ...
        // 百分比
        cxt.beginPath();
        const text = `${Math.floor((100 / 360) * angle)}%`;
        cxt.font = "20px serif";
        cxt.fillStyle = "red";
